...
| **Godot 4.7+** | Game engine | [godotengine.org](https://godotengine.org/download/) |
| **Python 3.10+** | MCP server runtime + hook validation | [python.org](https://www.python.org/) |
| **uv** | Python package manager for MCP server | `winget install astral-sh.uv` or `pip install uv` |
...
godot --version        # Should show Godot 4.7+
...
After cloning, install the Python MCP server dependencies:
